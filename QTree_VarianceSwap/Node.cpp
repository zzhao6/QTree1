...
void Node::baCalc_variance_sim(){
	double optResult_variance_sim = 0;
	optResult_variance_sim += this->probArr[0] * (( exp(this->childNodePtrs[0]->x - this->x)-1 ) * ( exp(this->childNodePtrs[0]->x - this->x)-1 )+this->childNodePtrs[0]->optValueNode_variance_sim);
	optResult_variance_sim += this->probArr[1] * (( exp(this->childNodePtrs[1]->x - this->x)-1 ) * ( exp(this->childNodePtrs[1]->x - this->x)-1 )+this->childNodePtrs[1]->optValueNode_variance_sim);
	optResult_variance_sim += this->probArr[2] * (( exp(this->childNodePtrs[2]->x - this->x)-1 ) * ( exp(this->childNodePtrs[2]->x - this->x)-1 )+this->childNodePtrs[2]->optValueNode_variance_sim);
	optResult_variance_sim += this->probArr[3] * (( exp(this->childNodePtrs[3]->x - this->x)-1 ) * ( exp(this->childNodePtrs[3]->x - this->x)-1 )+this->childNodePtrs[3]->optValueNode_variance_sim);

	this->optValueNode_variance_sim = optResult_variance_sim;
}
...
double Node::getOpt_variance_std(){
	return optValueNode_variance_std;
}

double Node::getOpt_variance_sim(){
	return optValueNode_variance_sim;
}
